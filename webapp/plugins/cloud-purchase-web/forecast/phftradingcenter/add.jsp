	...
	<mk-form-panel title="" num="2" margin_bottom="10px">
	     ...
	     <!-- <mk-form-row>
		     <div class="pull-right">
		         <su-button s-type="primary"  @click="addGrid(2)" class="btn-width-small">新增</su-button>
		         <su-button s-type="default"  @click="deleteGrid(2)" class="btn-width-small">删除</su-button>
	    	 </div>
	     </mk-form-row> -->
	</mk-form-panel>
	...
	methods: {
		confirm:function(){
            ...
            if(this.valid==true){
            	...
            	$.ajax({
					url:basePath+"cloud-purchase-web/phfTradingCenterController/saveInfo",
					type:'post',
