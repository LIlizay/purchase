...
<mk-top-bottom height="100%" top_height="auto">
	...
	<mk-panel title="年度经营计划列表"  line="true" slot="bottom" height="100%">
		<div slot="buttons" class="pull-right " style="text-align:right" v-cloak>
	        <su-button class="btn-operator" s-type="default" labeled="true" label-ico="edit" v-on:click="edit">电量收集</su-button>
	...
	methods: {
		...
		edit:function(){
			...
			if(row.planStatus!=="02"){
				MainFrameUtil.alert({title:"警告",body:"只有【已制定】状态的计划才能修改！"});
				return;
			}
			var me = this;
	  		MainFrameUtil.openDialog({
	  			id:"edit",
	  			params:{planId:row.planId,year:row.year,setters:row.setters},
				href:'${Config.baseURL}view/cloud-purchase-web/plan/phmbusinessconsrela/edit',
				iframe:true,
				modal:true,
				width:1000,
				height:620,
		...
		submit:function(){
			...
			if(row.planStatus!=="02"){
				MainFrameUtil.alert({title:"警告",body:"只有【已制定】状态的计划才能提交！"});
				return;
			}
			$.ajax({
				url : basePath + "cloud-purchase-web/phmBusinessConsRelaController/submit",
   	   			type : 'post',
   	   			data : row.id,
