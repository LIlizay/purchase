       ...
       <script type="text/javascript">
             ...
             var consAddVue=new Vue({
                    ...
                    ready:function(){
                           ...
                           me.params.scConsumerInfo.consType = "02"       //默认是意向用户，而且不允许更改
                           $.validator.addMethod(
		                   ...
		                   //省 初始值
		      				if(cloudsellingProvince == null || ''== cloudsellingProvince){
		      					...
		      					if(userInfo.orgCode != null && userInfo.orgCode !=''){
			      					this.params.scConsumerInfo.provinceCode = (userInfo.orgCode).substr(0,2) + '0000';
		      					}else{
		      						//山东
		      						this.params.scConsumerInfo.provinceCode = '370000';
		      					}
		     					
		      				}else{
		      					this.params.scConsumerInfo.provinceCode = cloudsellingProvince;
		      				}
                    },
                    methods: {
                           //按钮组
	                    getButtons:function(){
                           ...
                           endEditing:function(){
                                 ...
                                 me.params.mpList = datas;
                                 return true;
                           },
                           append:function(){
//                               if($('#mpInfoGrid').datagrid('getRows').length < 1){
...
//                               }else{
//                                      MainFrameUtil.alert({title:"提示",body:"只能添加一个计量点！"});
//                               }
                                 ...
                                 if(row){
                                         MainFrameUtil.confirm({
                                                ...
                                                onClose:function(type){
                                                    if(type=="ok"){//确定
                                                     if(row.consId != null && row.consId != ""){//保存后再删除
                                                            $.ajax({
                          ...
                          if(me.valid===false){
                                 ...
                                 $.ajax({
                                        ...
                                        success : function(result) {
                                               if(result.flag){
                                            	   ...
                                            	   var list = result.data.mpList;
                                                   $("#mpInfoGrid").datagrid("loadData",list);
                                                  for(var i in list){
                                                         $("#mpInfoGrid").datagrid("beginEdit",i);
                                                  }
                                                  me.params.mpList = list;
                           ...
                           save: function(){
                                 ...
                                 $.ajax({
                                        url : "${Config.baseURL}cloud-purchase-web/scConsumerInfoController/saveScConsumerInfo",
                                        type : 'post',
                                        data:$.toJSON(this.params),
                                        contentType : 'application/json;charset=UTF-8',
                                        success : function(result) {
                                            if(result.flag){
                                                  consMainAddVue.consId = result.data.scConsumerInfo.id;
                                                  me.params.scConsumerInfo = result.data.scConsumerInfo;
                                                  me.params.scContactsInfo = result.data.scContactsInfo;
                                                  var list = result.data.mpList;
                                                   $("#mpInfoGrid").datagrid("loadData",list);
                                                  for(var i in list){
                                                         $("#mpInfoGrid").datagrid("beginEdit",i);
                           ...
                           selectCons:function(){
                                 ...
                                 MainFrameUtil.openDialog({
                                        ...
                                        params:{"singleSelect":true,excludeConsIds : me.params.scConsumerInfo.consPath},
                                        iframe:true,
                                        modal:true,
                                        width:'50%',
                                        height:620,
                          ...
                          manageUsuallyDate: function(){
	                          ...
	                          MainFrameUtil.openDialog({
	                                 ...
	                                 params:{"consId": consMainAddVue.consId, saveList: $.parseJSON($.toJSON(me.params.usuallyDateList))},
	                                 iframe:true,
	                                 modal:true,
	                                 width:800,
	                                 height:520,
	                                 ...
	                                 onClose:function(params){
	                                	 //没有保存之前consId为null
	                                	 if(consMainAddVue.consId == null || consMainAddVue.consId == ""){
		                                     if(typeof(params.saveList)==="object"){
		                                    	 me.params.usuallyDateList = params.saveList;
