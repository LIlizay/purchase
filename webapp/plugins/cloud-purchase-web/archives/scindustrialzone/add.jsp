...
<mk-panel title="新增园区维护" line="true">
...
var zoneAddVue = new Vue({
    ...
    ready:function(){
    	...
    	//设置按钮
        MainFrameUtil.setDialogButtons(this.getButtons(),"zoneAdd");
    ...
    methods:{
    	...
    	initCode:function(code,type){
    		...
    		$.ajax({
                ...
                success : function(data) {
                	if(type == "cityCode"){
                		zoneAddVue.cityCodeList = data;
                	}else if(type == "countyCode"){
                		zoneAddVue.countyCodeList = data;
                	}
                }
			})
    	},
        	...
        	$.ajax({
                ...
                success : function(data) {
                	if(data.flag){
                		 ...
                		 MainFrameUtil.closeDialog("zoneAdd");
                	}else{
                		MainFrameUtil.alert({
                            title:"失败提示：",
                            body:data.msg,
        ...
        //按钮组
        getButtons:function(){
        	var buttons = [{text:"保存",type:"primary",handler:this.save},{text:"取消",handler:function(){MainFrameUtil.closeDialog("zoneAdd")}}];
            return buttons;
        }
    },
