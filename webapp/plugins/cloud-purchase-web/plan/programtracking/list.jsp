...
<mk-top-bottom height="100%" top_height="auto">
	...
	<mk-panel title="年度购电计划列表"  line="true" slot="bottom" height="100%">
		<div slot="buttons" class="pull-right " style="text-align:right" v-cloak>
	        <su-button class="btn-operator" s-type="default" labeled="true" label-ico="edit" v-on:click="edit">方案跟踪</su-button>
  		</div>
	    <div id="listGrid" ></div>
	</mk-panel>
</mk-top-bottom>
...
var listVue = new Vue({
		...
		$("#listGrid").treegrid({
			...
			columns:[[
			     //     {title:"年份",field:"year",width:80,formatter:me.yearFormatter},
			          ...
			          {title:"总合同电量 （兆瓦时）",field:"agrePq",width:120},
			          {title:"合同总销售额（元）",field:"agreAmt",width:80},
	...
	methods: {
		...
		edit:function(){
			...
			if(row==null||typeof(row.schemeId)==='undefined'){
				MainFrameUtil.alert({title:"警告",body:"请方案数据！"});
				return;
			}
			var me = this;
	  		MainFrameUtil.openDialog({
	  			id:"edit",
	  			params:{id:row.schemeId,planName:row.planName},
				href:'${Config.baseURL}view/cloud-purchase-web/plan/programtracking/edit',
				iframe:true,
				modal:true,
				width:1000,
				height:600
		...
		yearFormatter:function(value,row,index){
			return "<a onclick=\"listVue.planDetail('"+row.planId+"')\">"+value+"</a>";
		},
