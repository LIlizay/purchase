...
<body id="phPlanEditVue" >
	...
	<script type="text/javascript">
		...
		var phPlanEditVue=new Vue({
			...
			ready:function(){
				var me = this;
				me.planId = MainFrameUtil.getParams("plan_detail").planId;
				me.planStatus = MainFrameUtil.getParams("plan_detail").planStatus;
				me.ym = MainFrameUtil.getParams("plan_detail").ym;
				me.mode = MainFrameUtil.getParams("plan_detail").mode;
				me.initDivCss();
				me.initFrame();
			},
			methods: {
				...
				initFrame: function(){
					...
					if(me.planStatus == "00"){
						...
						if(cloudsellingProvince != "140000" && cloudsellingProvince != "210000" && cloudsellingProvince != "410000"){
							debugger;
							if(me.mode == "02"){
								document.getElementById("contentFrameId").src = "${Config.baseURL}view/cloud-purchase-web/bid/phmpurchaseplanflow/plan_03/detail/edit_sb_detail?planId="+me.planId;
							}else{
								document.getElementById("contentFrameId").src = "${Config.baseURL}view/cloud-purchase-web/bid/phmpurchaseplanflow/plan_03/detail/edit_detail?planId="+me.planId;
							}
						}else{
							debugger;
							if(me.mode == "02"){
								document.getElementById("contentFrameId").src = "${Config.baseURL}view/cloud-purchase-web/bid/phmpurchaseplanflow/plan_03/detail/sl_edit_sb_detail?planId="+me.planId;
							}else{
								document.getElementById("contentFrameId").src = "${Config.baseURL}view/cloud-purchase-web/bid/phmpurchaseplanflow/plan_03/detail/sl_edit_detail?planId="+me.planId;
							}
						}
					}
				},
