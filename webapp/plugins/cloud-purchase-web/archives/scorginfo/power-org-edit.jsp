...
<script>
	...
	var addOrgVue=new Vue({
	    ...
	    ready:function(){
            ...
            MainFrameUtil.setDialogButtons(this.getButtons(),"editPowerOrgDialog");
            var that = this;
	        ...
	        getButtons:function(){
                var buttons=[{
                    ...
                    handler:function(btn,params){
                    	/* 表单验证 */
                    	addOrgVue.$refs.power_org.valid();
        	            ...
        	            $.ajax({
                            ...
                            success : function(data) {
                                ...
                                if(data.flag == true){
                                	...
                                	MainFrameUtil.closeDialog("editPowerOrgDialog");
                                }else{
                                	MainFrameUtil.alert({title:"失败提示",body:data.msg}); 
                                }
                            },
