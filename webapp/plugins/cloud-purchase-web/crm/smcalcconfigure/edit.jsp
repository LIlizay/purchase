...
<mk-panel title="编辑算法配置" line="true">
    <mk-form-panel label-width="150px" class="mt_10" num="2">
            ...
            <mk-form-row >
                 <!--售电公司(库名) -->
                <mk-form-col :label="formFields.sellDbName.label" required_icon="true">
            ...
            <mk-form-row  height="90px">
                <!-- 算法说明 -->
                <mk-form-col  colspan="2" :label="formFields.calcContent.label">
                    <su-textbox type="textarea" rows="3" rols="10" placeholder="" :data.sync="params.smCalcConfigure.calcContent"></su-textbox>
                </mk-form-col>
            </mk-form-row>
    </mk-form-panel>
</mk-panel>
...
var calcEditVue = new Vue({
    ...
    ready:function(){
        ...
        //获取id
        this.params.smCalcConfigure.id = MainFrameUtil.getParams("calcEdit").id;
        //设置按钮
        MainFrameUtil.setDialogButtons(this.getButtons(),"calcEdit");
        me.initGrid();
        //初始化加载
        me.initData();
    },
            ...
            $.ajax({
                ...
                success : function(data) {
                    if(data.flag){
                         ...
                         MainFrameUtil.closeDialog("calcEdit");
                    }else{
                        MainFrameUtil.alert({
                            title:"失败提示：",
                            body:data.msg,
