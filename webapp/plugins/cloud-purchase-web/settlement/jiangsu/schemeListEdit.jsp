...
<script type="text/javascript">
    ...
    var sellSettlementVue = new Vue({
        ...
        ready:function(){
        	var that = this;
        	that.formData.id = MainFrameUtil.getParams("settleSchemeEditDialog").id;
        	that.formData.ym = MainFrameUtil.getParams("settleSchemeEditDialog").ym.substr(0,4) +"-" 
        				+ MainFrameUtil.getParams("settleSchemeEditDialog").ym.substr(4,2); 
        	
        	MainFrameUtil.setDialogButtons(this.getButtons(),'settleSchemeEditDialog');
        ...
        methods:{
    		...
    		getButtons:function(){
    			...
    			var buttons = [
    				...
    				{text:"取消",handler:function(){MainFrameUtil.closeDialog('settleSchemeEditDialog')}}];
    			return buttons;
    		}
        }
    })
