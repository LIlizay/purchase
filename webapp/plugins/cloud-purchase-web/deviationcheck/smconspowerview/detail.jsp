...
//      var row = MainFrameUtil.getParams("conspowerAdd").row;
     	this.params = MainFrameUtil.getParams("conspowerAdd").row;
...
//      this.params.ym = row.ym;
	...
	methods:{
        ...
        getButtons:function(){
        	var me = this;
        	var buttons = [{text:"关闭",handler:function(){MainFrameUtil.closeDialog("conspowerAdd")}}];
            return buttons;
        },
		...
		initData:function(){
			var me= this;
			$.ajax({
				url : basePath + "cloud-purchase-web/smConsPowerViewController/getPowerViewByCondIdAndYm",
   	   			type : 'post',
...
// 				}
				if(len % 7 != 0){
					html += "<td class='everyDay'>"+
								deviationClass+
								"<p style='margin-top:10px'>计划日用电量：" + dayPlanPq + "</p>"+
