...
public class PhmAgreTemplateDetail implements Serializable{
     ...
     * @since   1.0.0
    */
    private static final long serialVersionUID = 2076316207524658035L;
    ...
    /** 合同类型 **/
    @PropertyAnnotation(cacheType=ConstantsStatus.CACHE_TYPE_PCODE,domain=ConstantsStatus.PCODE_DOMAIN_SELLING,key="purchase_agreType" ,field="templateTypeName")
