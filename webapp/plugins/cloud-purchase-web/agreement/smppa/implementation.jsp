...
<mk-form-panel title="售电合同电量分月执行情况" >
	...
	<mk-form-row>
        ...
        <mk-form-col :label="formFields.agreePq.label" >
            <su-textbox :data.sync="proxyPq" :addon="{'show':true,'rightcontent':'兆瓦时'}" disabled></su-textbox>
        </mk-form-col>
        <!-- 已结算电量 -->
...
var detailVue = new Vue({
	...
	ready:function(){
		...
		$.ajax({
    		url:basePath + 'cloud-purchase-web/smPpaController/' + id,
    		type:"get",
		...
		ComponentUtil.getFormFields("selling.agreement.implementation",this);
		$('#monthGrid').datagrid({
			 url:basePath+"cloud-purchase-web/smPpaController/getImplementation",
			 queryParams:{id:id},
			 method:"get",
			 columns:[[
			 ...
			 onLoadSuccess:function(data){
				me.proxyPq = data.rows[0].proxyPq;
			 } 
		})
